        ...
        <div class="col-sm-3">
            <form action="customerloandisbursal" method="get">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="customerCode" placeholder="Enter customer_Id here..."
        ...
        <div class="col-sm-3 offset-sm-4">
            <form action="loandisbursalDetails" method="get">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="loanApplicationNumber" required
                           placeholder="Enter LoanApp_Id here..."/><input type="submit" value="Submit">
